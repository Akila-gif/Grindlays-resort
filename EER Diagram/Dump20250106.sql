...
INSERT INTO `payment` VALUES (1,11000.00,10000.00,0,500.00),(2,22000.00,11000.00,0,0.00),(3,17000.00,10000.00,0,0.00),(4,15500.00,6000.00,0,0.00);
/*!40000 ALTER TABLE `payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `payment_has_reservation`
--

DROP TABLE IF EXISTS `payment_has_reservation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `payment_has_reservation` (
  `Payment_id` int NOT NULL,
  `reservation_id` int NOT NULL,
  `paidamount` decimal(10,2) DEFAULT NULL,
  `dateandtime` datetime DEFAULT NULL,
  `payment_reason_id` int NOT NULL,
  KEY `fk_Payment_has_reservation_reservation1_idx` (`reservation_id`),
  KEY `fk_Payment_has_reservation_Payment1_idx` (`Payment_id`),
  KEY `fk_Payment_has_reservation_payment_reason1_idx` (`payment_reason_id`),
  CONSTRAINT `fk_Payment_has_reservation_Payment1` FOREIGN KEY (`Payment_id`) REFERENCES `payment` (`id`),
  CONSTRAINT `fk_Payment_has_reservation_payment_reason1` FOREIGN KEY (`payment_reason_id`) REFERENCES `payment_reason` (`id`),
  CONSTRAINT `fk_Payment_has_reservation_reservation1` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `payment_has_reservation`
--

LOCK TABLES `payment_has_reservation` WRITE;
/*!40000 ALTER TABLE `payment_has_reservation` DISABLE KEYS */;
INSERT INTO `payment_has_reservation` VALUES (1,1,5000.00,'2024-10-09 00:00:00',0),(1,1,5000.00,'2024-10-10 00:00:00',0),(2,21,5000.00,'2024-10-09 00:00:00',1),(3,22,5000.00,'2024-10-09 00:00:00',1),(4,23,5000.00,'2024-10-09 00:00:00',1);
/*!40000 ALTER TABLE `payment_has_reservation` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `payment_reason` VALUES (1,'Advance'),(2,'Restaurant'),(3,'Banquit Payment'),(4,'Other');
...
INSERT INTO `reservation` VALUES (1,'Res1',7,1,2),(21,'RES2',5,1,2),(22,'RES3',5,1,2),(23,'RES4',5,1,2);
...
INSERT INTO `reservation_has_roompackage` VALUES (1,1,2,7000.00),(21,1,NULL,7025.00),(21,3,NULL,4500.00),(22,1,4,7025.00),(22,3,4,4500.00),(23,1,4,7025.00),(23,3,4,4500.00);
...
INSERT INTO `reservation_has_service` VALUES (1,6,3,4500.00),(1,7,2,9000.00),(21,1,4,4000.00),(21,4,4,18096.00),(22,1,4,4000.00),(22,4,4,18096.00),(23,1,4,4000.00),(23,4,4,18096.00);
...
-- Dump completed on 2025-01-06  1:19:29
