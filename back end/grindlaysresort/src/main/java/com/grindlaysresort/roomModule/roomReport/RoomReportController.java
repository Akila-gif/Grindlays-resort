...
public class RoomReportController {
    ...
    @GetMapping("/roomlist")
    public List<Employee> findCustomerByDynamicCriteria(@RequestParam(required = false)Integer roomstates_id, @RequestParam(required = false) Integer viewtype_id, @RequestParam(required = false)Integer roomtype_id, @RequestParam(required = false) Integer maxheadcount, @RequestParam(required = false) BigDecimal min_price, @RequestParam(required = false) BigDecimal max_price , @RequestParam(required = false) String orderbytype , @RequestParam(required = false) String asendordesend ) {
