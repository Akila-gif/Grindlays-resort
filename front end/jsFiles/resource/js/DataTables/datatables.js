 ...
 *   https://datatables.net/download/#bs5/dt-1.13.8/rr-1.4.1/sc-2.3.0/sb-1.6.0
 *
 * Included libraries:
 *   DataTables 1.13.8, RowReorder 1.4.1, Scroller 2.3.0, SearchBuilder 1.6.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.8/rr-1.4.1/sc-2.3.0/sb-1.6.0",
